        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoughtById = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Caffs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Caffs_AspNetUsers_BoughtById",
                        column: x => x.BoughtById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Caffs_AspNetUsers_UploaderId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CaffId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentedCaffId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comments_Caffs_CommentedCaffId",
                        column: x => x.CommentedCaffId,
                        principalTable: "Caffs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Caffs_BoughtById",
                table: "Caffs",
                column: "BoughtById");

            migrationBuilder.CreateIndex(
                name: "IX_Caffs_UploaderId",
                table: "Caffs",
                column: "UploaderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_CommentedCaffId",
                table: "Comments",
                column: "CommentedCaffId");
